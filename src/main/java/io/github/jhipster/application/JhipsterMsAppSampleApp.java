...
public class JhipsterMsAppSampleApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMsAppSampleApp.class);

    private final Environment env;

    public JhipsterMsAppSampleApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMSAppSample.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMsAppSampleApp.class);
